...
steps:
  - step: Installing Nginx as a reverse proxy 
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-nginx-reverse-proxy-s3/#Installing-Nginx-as-a-reverse-proxy
  - step: Configuring Nginx as a reverse proxy
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-nginx-reverse-proxy-s3/#Configuring-Nginx-as-a-reverse-proxy
  - step: Configuring HTTPS
    type: HowToStep
    url: https://www.scaleway.com/en/docs/tutorials/setup-nginx-reverse-proxy-s3/#Configuring-Nginx-as-a-reverse-proxy-for-HTTPS
categories:
  - storage
  - object-storage
dates:
  validation: 2021-11-30
  posted: 2020-06-04
---

## Object Storage Proxy Overview

[Scaleway Object Storage](/storage/object/) allows you to store unlimited data in [buckets](/storage/object/concepts/#bucket). You can access the data directly via your bucket.
